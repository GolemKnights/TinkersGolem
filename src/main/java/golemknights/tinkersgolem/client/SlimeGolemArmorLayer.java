...
public class SlimeGolemArmorLayer <T extends SlimeGolemEntity, M extends HierarchicalModel<T>, A extends HumanoidModel<T>> extends RenderLayer<T,M> {
    private final A armorModel;
    public final Map<SkullBlock.Type, SkullModelBase> skullModels;
    public SlimeGolemArmorLayer(RenderLayerParent<T,M> pRenderer, A armorModel, EntityModelSet modelSet) {
        super(pRenderer);
