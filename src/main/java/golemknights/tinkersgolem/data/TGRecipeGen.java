...
public class TGRecipeGen {
	public static void genRecipe(RegistrateRecipeProvider pvd) {
		...
		// upgrades
		{
			...
			unlock(pvd, ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TGGolemModifiers.SLIMESTEEL_EXPAND.get(), 1)::unlockedBy, GolemItems.ADD_DIAMOND.get())
			...
			unlock(pvd, ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TGGolemModifiers.ITEM_SUPER_OVERGROWTH.get(), 1)::unlockedBy, TGGolemModifiers.ITEM_OVERGROWTH.get())
					...
					.requires(TinkerWorld.bloodshroom.getLogItemTag())
			...
			unlock(pvd, ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TGGolemModifiers.ITEM_OVERWORKED.get(), 1)::unlockedBy, GolemItems.EMPTY_UPGRADE.get())
					...
					.requires(Ingredient.of(TinkerMaterials.roseGold.getIngotTag()), 3)
			...
			unlock(pvd, ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TGGolemModifiers.ITEM_OVERDRIVE.get(), 1)::unlockedBy, GolemItems.EMPTY_UPGRADE.get())
					...
					.requires(TinkerWorld.bloodshroom.getLogItemTag())
					.requires(TinkerWorld.enderbark.getLogItemTag())
					.requires(TinkerWorld.earthGeode.getBlock())
					.requires(TinkerWorld.skyGeode.getBlock())
					.requires(TinkerWorld.ichorGeode.getBlock())
					.requires(TinkerWorld.enderGeode.getBlock())
					.save(pvd);
